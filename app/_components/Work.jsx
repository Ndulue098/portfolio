...
export default function Work({isDark}) {
  return (
    ...
    id="Work" className="w-full px-[12%] py-10 scroll-mt-20">
        ...
        className="text-center text-lg font-Ovo mb-2">My portfolio</motion.h4>
        <motion.h2
        initial={{y:-20,opacity:0}}
        whileInView={{y:0,opacity:1}}
        ...
        className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">
            welcome to my web development portfolio Explore a collection of projects showcasing my expertise in front-end developmet
        </motion.p>
        ...
        className="grid grid-cols-auto my-10 gap-5 dark:text-black">
            {workData.map((project,i)=>(
                ...
                key={i} className="aspect-square bg-cover bg-center rounded-lg relative cursor-pointer group" style={{backgroundImage:`url(${project.bgImage}`}}>
        ...
        hover:bg-lightHover duration-500  dark:text-white dark:border-white dark:hover:bg-darkHover  ">
            Show more
            <Image src={isDark?assets.right_arrow_bold_dark:assets.right_arrow_bold} alt="right arrow" className="w-4"/>
        </motion.a>
    </motion.div>
  );
}
